...
import { TagType } from "@/app/(admin)/admin/dashboard/tags/page";
                                ...
                                <>
                                    <div>
                                        ...
                                        <div className={`px-3 py-2 rounded-lg ${isDark ? 'bg-gray-700' : 'bg-gray-50'}`}>
                                            {formatDate(currentTag.createdAt)}
                                        </div>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium mb-1">
                                        ...
                                        <div className={`px-3 py-2 rounded-lg ${isDark ? 'bg-gray-700' : 'bg-gray-50'}`}>
                                            {formatDate(currentTag.updatedAt)}
                                        </div>
                                    </div>
                                </>
                            )}
                        ...
                        <div className="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-700">
                            ...
                            {!isViewOnly && (
                                ...
                                >
                                    ...
                                    {modalType === "add" ? t("tags.form.create") : t("tags.form.update")}
                                </button>
                            )}
                        </div>
                    </form>
